 ...
 */
final class Version20190227165510 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE articles ADD category_id INT NOT NULL, DROP title');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE articles ADD title VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, DROP category_id');
    }
}
